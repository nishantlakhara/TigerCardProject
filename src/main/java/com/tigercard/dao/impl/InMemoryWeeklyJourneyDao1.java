...
public class InMemoryWeeklyJourneyDao1 implements JourneyDao1<Fare> {
    Map<Integer, Map<DayRange, Fare>> fareMapWeekly = new HashMap<>();
    Map<Integer, Map<DayRange, Integer>> cappingMapWeekly = new HashMap<>();
    Map<Zone, Integer> weeklyCapping = CappingConstants.getInstance().getCapping(CappingType.WEEKLY);
